    ...
    <section class="conteudo-corpo">
        <div class="row artigos-produtos">
            <div class="col-md-9 fundo-branco-transparente">
                <div class="titulo"><h4>Forma de pagamento</h4></div>
                <div class="formapagamento"></div>

                <div class="topicospagamento">
                    <h3>Pagamento no ato da entrega!</h3>
                    <h4>Ganhe até 10% de desconto, válido para toda a região!</h4>
                    <p>Este é o método mais prático para quem deseja pagar à vista. Você poderá efetuar o pagamento no ato da entrega
                        essa é a forma de pagamento que recebe o maior desconto para cliente final sob o valor total da compra.
                        <p id="obs">O total a pagar de sua compra é de: <h4><?php echo 'R$ '."$total" ?></h4> Por este método de pagamento, será <h4><?php echo 'R$ '.$descontoavista ?></h4> </p>
                    <p align="right" id="botaoavista"><a class="btn btn-info" href="#" role="button">SOLICITAR PAGAMENTO NO ATO</a></p>
                </div>
                <div class="topicospagamento"></div>
                <div class="topicospagamento"></div>
