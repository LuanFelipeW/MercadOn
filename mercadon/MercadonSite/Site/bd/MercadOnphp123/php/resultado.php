...
$procurabd = "SELECT * FROM produtos WHERE produto LIKE '%$recebendoinf%' ORDER BY PRECO ASC ";
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#modal_cadastrar">Cadastrar</a></li>
                    </ul>
                    </ul>
